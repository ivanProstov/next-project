...
const MONGO_URI = 'mongodb://root:297ugbT1DM@localhost:27017/glow?authSource=admin&authMechanism=SCRAM-SHA-1&directConnection=true';
...
app.prepare().then(async () => {
    ...
    server.use(startMiddlewarets(middlewareAuth, middlewareHomeRedirect, middlewareLoginRedirect))
